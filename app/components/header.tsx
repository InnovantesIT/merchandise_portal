              ...
              {isDropdownOpen && (
                <motion.div
                  ...
                  className={`absolute right-0 mt-3 ${
                    showLogoutAlert ? 'w-64 h-28 ' : 'w-44 h-auto'
                  } rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none z-[1000]`}
                >
                  {!showLogoutAlert ? (
                    <div className="py-1">
